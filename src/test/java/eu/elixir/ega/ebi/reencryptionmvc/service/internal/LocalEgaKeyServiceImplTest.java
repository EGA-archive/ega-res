...
/**
 * Test class for {@link LocalEgaKeyServiceImpl}.
 * 
 * @author amohan
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ LocalEgaKeyServiceImpl.class, Gson.class, IOUtils.class })
public class LocalEgaKeyServiceImplTest {

    @InjectMocks
    private LocalEgaKeyServiceImpl localEgaKeyServiceImpl;
    ...
    public void testGetRSAKeyById() throws Exception {
        ...
        byte[] outputRSAKey = localEgaKeyServiceImpl.getRSAKeyById("id");
    ...
    public void testGetPGPPublicKeyById() throws Exception {
        try {
            ...
            localEgaKeyServiceImpl.getPGPPublicKeyById("id");
    ...
    /**
     * Test class for {@link LocalEgaKeyServiceImpl#getFileKey(String)}. Expected
     * exception as operation Not supported yet.
     */
    @Test(expected = UnsupportedOperationException.class)
    public void testGetFileKey() {
        localEgaKeyServiceImpl.getFileKey("fileId");
    }

    /**
     * Test class for {@link LocalEgaKeyServiceImpl#getKeyPath(String)}. Expected
     * exception as operation Not supported yet.
     */
    @Test(expected = UnsupportedOperationException.class)
    public void testGetKeyPath() {
        localEgaKeyServiceImpl.getKeyPath("key");
    }

    /**
     * Test class for {@link LocalEgaKeyServiceImpl#getFormats()}. Expected
     * exception as operation Not supported yet.
     */
    @Test(expected = UnsupportedOperationException.class)
    public void testGetFormats() {
        localEgaKeyServiceImpl.getFormats();
    }
