...
import eu.elixir.ega.ebi.egacipher.experimental.BufferedBackgroundSeekableInputStream;
    ...
    private SeekableStream getSource(String sourceFormat, 
        ...
        try {
            ...
            if (sourceFormat.equalsIgnoreCase("plain")) {
                ...
                plainIn = new EgaSeekableCipherStream(fileIn, sourceKey.toCharArray(), (int) BUFFER_SIZE, 128);
                ...
                plainIn = new EgaRemoteSeekableCipherStream(fileIn, sourceKey.toCharArray(), (int) BUFFER_SIZE, 256);
            } else if (sourceFormat.equalsIgnoreCase("symmetricgpg")) {
...
//    @HystrixCommand
    private OutputStream getTarget(OutputStream outStream,
        ...
        if (destinationFormat.equalsIgnoreCase("plain")) {
            ...
            out = new EgaGPGOutputStream(outStream, gpgKey); // Public Key GPG
...
//    @HystrixCommand
    public PGPPublicKey getPublicGPGKey(String destinationFormat) throws IOException {
        ...
        } catch (IOException | PGPException ex) {in.reset(); error=true;}
        if (pgKey==null || error) {
            try {
